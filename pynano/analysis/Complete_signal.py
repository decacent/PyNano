...
def fitting_data(data,baseline,rms):
    ...
    modified_c[signal_start:signal_end+1]=modified_c[signal_start:signal_end+1].mean()
    return modified_c
...
def annalysis(dataset,shrehold=35):
    ...
    startp=[]
    endp=[]
    #find out the start point and end point of signal according to seted shrehold
